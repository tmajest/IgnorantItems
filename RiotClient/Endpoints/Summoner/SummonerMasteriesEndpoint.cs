...
{
    internal class SummonerMasteriesEndpoint : RiotEndpoint
    {
        private string summonerIds;

        public override string ApiBase => "api/lol/{0}/v{1}/summoner/{2}/masteries";

        public SummonerMasteriesEndpoint(string region, string version, string apiKey, string summonerIds)
