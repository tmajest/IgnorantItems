...
{
    internal class SummonerRunesEndpoint : RiotEndpoint
    {
        private string summonerIds;

        public override string ApiBase => "api/lol/{0}/v{1}/summoner/{2}/runes";

        public SummonerRunesEndpoint(string region, string version, string apiKey, string summonerIds)
